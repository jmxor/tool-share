...
import { UserRound, Calendar1, Gavel, MessageCircleMore } from "lucide-react";
			...
			<TooltipProvider>
				<div className="flex flex-col md:flex-row gap-2 max-w-full w-full">
					<div className="flex flex-col bg-white shadow-md items-center mb-4 gap-2 min-w-64 p-8 rounded-lg mt-2 h-fit">
						...
						<Button className="mt-1 bg-blue-500 hover:bg-blue-600">Send Message <MessageCircleMore /></Button>
					</div>
					<div className="flex flex-col md:flex-row bg-white shadow-md mb-4 gap-2 p-8 rounded-lg mt-2 w-full h-screen">
