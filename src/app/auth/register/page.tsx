...
import { RegistrationFormSchema } from "@/lib/zod";
import { RegistrationFormState, registerUser } from "@/lib/auth/actions";
...
export default function RegistrationPage() {
    ...
    const form = useForm<z.output<typeof RegistrationFormSchema>>({
